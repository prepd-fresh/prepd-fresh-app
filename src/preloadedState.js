const preloadedState = {
  ...
  products: {
    fdga78df6gasd: {
      ...
      dek:
        "Prime Mongolian beef cooked to perfection, loaded with savory asian style sauce. Served with an ample amount of rice and broccoli to provide a protein based meal that is perfect for dinners and post-workouts",
      veggie: false,
      imageUrl: "meal_1.jpg"
    },
    sd79fsd89afsd: {
